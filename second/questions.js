...
new Answer ("имя создателя JavaScript", 0)], "5"),
...
new Answer ("9", 0),
new Answer ("10", 1),
new Answer ("нет такой переменной после цикла", 0)], "8"),
...
new Answer ("глобальные видны повсюду, локальные только в функциях", 1)], "9"),
